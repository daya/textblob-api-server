...
FROM ubuntu:zesty
MAINTAINER Sébastien Guignot "daya.sharma@gmail.com"
...
RUN cd /srv && git clone https://github.com/daya/textblob-api-server.git
RUN cd /srv/textblob-api-server && pip install -r requirements.txt && pip install -U scikit-learn
